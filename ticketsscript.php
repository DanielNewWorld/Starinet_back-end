...
$chekError=2;
  ...
  $line="INSERT INTO `tickets`(`subject`,`user_id`, `user_acc_id`, `created`, `updated`, `department`,`priority`,`ip`) VALUES ('".$_GET['dbSubject']."',".$_GET['dbID'].",'".$_GET['dbAccountID']."','".$today."','".$today."','".$_GET['dbDepartment']."','".$_GET['dbPriority']."','')";
  $result = mysql_query($line);
  $ticketID = mysql_insert_id();

// Запись текста тикета
  $line="INSERT INTO `tickets_data`(`ticket_id`, `user_id`, `admin_id`, `created`, `text`, `files`, `ip`) VALUES (".$ticketID.",".$_GET['dbID'].",0,'".$today."','".$_GET['dbText']."','','')";
  $result = mysql_query($line);
